...
namespace gm {
    ...
    public:
        ...
        T length() const {
            return gm::sqrt(x * x + y * y + z * z + w * w);
        }
        ...
        T distance(const gm_vec4<T> &vTo) const {
            ...
            return static_cast<T>(gm::sqrt(disX*disX +  disY*disY + disZ*disZ + disW*disW));
        }
        ...
        bool operator== (const gm_vec4<T>& v) const {
